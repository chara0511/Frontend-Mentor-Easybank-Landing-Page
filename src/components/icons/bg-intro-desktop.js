  ...
  return (
    ...
    >
      ...
      <g fill="none" fillRule="evenodd" transform="translate(15)">
        <use
          fill="#000"
          filter="url(#bgIntroDesktopFilter)"
          xlinkHref="#bgIntroDesktopPath"
        ></use>
        <use fill="#2D314D" xlinkHref="#bgIntroDesktopPath"></use>
        <path
          fill="url(#bgIntroDesktopGradient)"
