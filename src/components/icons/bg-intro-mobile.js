  ...
  return (
    ...
    >
      ...
      <g fill="none" fillRule="evenodd" transform="translate(-94 -52)">
        <use
          fill="#000"
          filter="url(#bgIntroMobileFilter)"
          xlinkHref="#bgIntroMobilePath"
        ></use>
        <use fill="#2D314D" xlinkHref="#bgIntroMobilePath"></use>
        <path
          fill="url(#bgIntroMobileGradient)"
